...
def train_911(model, train_loader, optimizer, lr_scheduler, device,
...
learning_rate_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, train_config["num_epochs"], eta_min=0.0, last_epoch=-1)
